...
export const getCategories = () => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.get('/api/fooditems/getCategories',config);
    //console.log(data);
...
export const addCategory = (category) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.post('/api/adminActions/addCategory', { name: category },config);
